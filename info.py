...
PICS = (environ.get('PICS', 'https://graph.org/file/f4d2d7de2292f022f5032.jpg')).split() #SAMPLE PIC
NOR_IMG = environ.get("NOR_IMG", "https://graph.org/file/b69af2db776e4e85d21ec.jpg")
MELCOW_VID = environ.get("MELCOW_VID", "https://t.me/How_To_Open_Linkl")
SPELL_IMG = environ.get("SPELL_IMG", "https://te.legra.ph/file/15c1ad448dfe472a5cbb8.jpg")

# Admins, Channels & Users
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002219453051'))
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002201544717') # give your force subscribe channel id here else leave it blank
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://G:G@cluster0.e3dcg2r.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
MSG_ALRT = environ.get('MSG_ALRT', 'eda mone ❤️')
